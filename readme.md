...
[![goproxy](https://goproxy.cn/stats/github.com/zjz894251se/go-zero/badges/download-count.svg)](https://goproxy.cn/stats/github.com/zjz894251se/go-zero/badges/download-count.svg)
...
```shell
GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/zjz894251se/go-zero
```
...
1. 安装 goctl 工具
    ...
    ```shell
    GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/zjz894251se/go-zero/tools/goctl
    ```
...
项目地址：[https://github.com/zjz894251se/go-zero](https://github.com/zjz894251se/go-zero)
